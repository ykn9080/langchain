...
from config import api_document, api_textsplit, api_misc,  api_embedding, api_vectorStores
...
docs = api_textsplit.recursivesplit(
    pages, 1000, 0, api_misc.tiktoken_len)
# print(docs)


embedding = api_embedding.getkosbertnli()
db3 = api_vectorStores.getdb("chroma", "data/chroma_db", embedding)
